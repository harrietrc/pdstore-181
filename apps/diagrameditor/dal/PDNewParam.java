...
/**
 * Data access class to represent instances of type "NewParam" in memory.
 * Note that this class needs to be registered with PDCache by calling:
 *    Class.forName("diagrameditor.dal.PDNewParam");
 * @author PDGen
 */
public class PDNewParam implements PDInstance,PDNewParamI{

	public static final GUID typeId = new GUID("b81a82ce9b1111e1a6ca002215eb452f"); 
	...
	public static void register() {
		PDStore.addDataClass(typeId, PDNewParam.class);
	}
	...
	public String toString() {
		String name = getName();
		if(name!=null)
			return "PDNewParam:" + name;
		else
			return "PDNewParam:" + id;
	}

	/**
	 * Creates an PDNewParam object representing a PDStore instance of type NewParam.
	 * @param store the store the instance should be in
	 */
	public PDNewParam(PDStore store) {
		this(store, new GUID());
	}

	/**
	 * Creates an PDNewParam object representing the instance with the given ID. 
	 * The ID must be of an instance of type NewParam.
	 * @param store the store the instance should be in
	 * @param id GUID of the instance
	 */
	public PDNewParam(PDStore store, GUID id) {
		this.store = store;
		this.id = id;
	...
	/**
	 * Loads an object for the instance of PDStore type NewParam with the given ID.
	 ...
	 * @param id GUID of the instance
	 */
	public static PDNewParam load(PDStore store, GUID id) {
		PDInstance instance = store.load(typeId, id);
		return (PDNewParam)instance;
	}
