...
/**
 * Data access class to represent instances of type "DiagramSet" in memory.
 * Note that this class needs to be registered with PDCache by calling:
 *    Class.forName("diagrameditor.dal.PDDiagramSet");
 * @author PDGen
 */
public class PDDiagramSet implements PDInstance,PDDiagramSetI{

	public static final GUID typeId = new GUID("f119cf11eda611e1b6c60026b97da292"); 

	public static final GUID roleDiagramId = new GUID("f119cf12eda611e1b6c60026b97da292");
	...
	public static void register() {
		PDStore.addDataClass(typeId, PDDiagramSet.class);
	}
	...
	public String toString() {
		String name = getName();
		if(name!=null)
			return "PDDiagramSet:" + name;
		else
			return "PDDiagramSet:" + id;
	}

	/**
	 * Creates an PDDiagramSet object representing a PDStore instance of type DiagramSet.
	 * @param store the store the instance should be in
	 */
	public PDDiagramSet(PDStore store) {
		this(store, new GUID());
	}

	/**
	 * Creates an PDDiagramSet object representing the instance with the given ID. 
	 * The ID must be of an instance of type DiagramSet.
	 * @param store the store the instance should be in
	 * @param id GUID of the instance
	 */
	public PDDiagramSet(PDStore store, GUID id) {
		this.store = store;
		this.id = id;
	...
	/**
	 * Loads an object for the instance of PDStore type DiagramSet with the given ID.
	 ...
	 * @param id GUID of the instance
	 */
	public static PDDiagramSet load(PDStore store, GUID id) {
		PDInstance instance = store.load(typeId, id);
		return (PDDiagramSet)instance;
	}
