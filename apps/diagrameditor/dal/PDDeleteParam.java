...
/**
 * Data access class to represent instances of type "DeleteParam" in memory.
 * Note that this class needs to be registered with PDCache by calling:
 *    Class.forName("diagrameditor.dal.PDDeleteParam");
 * @author PDGen
 */
public class PDDeleteParam implements PDInstance,PDDeleteParamI{

	public static final GUID typeId = new GUID("b81a82c69b1111e1a6ca002215eb452f"); 
	...
	public static void register() {
		PDStore.addDataClass(typeId, PDDeleteParam.class);
	}
	...
	public String toString() {
		String name = getName();
		if(name!=null)
			return "PDDeleteParam:" + name;
		else
			return "PDDeleteParam:" + id;
	}

	/**
	 * Creates an PDDeleteParam object representing a PDStore instance of type DeleteParam.
	 * @param store the store the instance should be in
	 */
	public PDDeleteParam(PDStore store) {
		this(store, new GUID());
	}

	/**
	 * Creates an PDDeleteParam object representing the instance with the given ID. 
	 * The ID must be of an instance of type DeleteParam.
	 * @param store the store the instance should be in
	 * @param id GUID of the instance
	 */
	public PDDeleteParam(PDStore store, GUID id) {
		this.store = store;
		this.id = id;
	...
	/**
	 * Loads an object for the instance of PDStore type DeleteParam with the given ID.
	 ...
	 * @param id GUID of the instance
	 */
	public static PDDeleteParam load(PDStore store, GUID id) {
		PDInstance instance = store.load(typeId, id);
		return (PDDeleteParam)instance;
	}
