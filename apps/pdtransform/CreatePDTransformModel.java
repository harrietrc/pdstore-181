...
public class CreatePDTransformModel {
	...
	private void createDALClasses() {
		PDGen.generateModel(store, "PDTransform Model", "apps", "pdtransform.dal");
		PDGen.generateModel(store, "Address Book Model", "apps", "pdtransform.dal");
		PDGen.generateModel(store, "HTML Model", "apps", "pdtransform.dal");
		PDGen.generateModel(store, "Serializer Model", "apps", "pdtransform.dal");
	}
