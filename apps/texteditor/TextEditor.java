...
public class TextEditor extends JFrame implements MouseListener {
	...
	public TextEditor(String arg0, PDStore store, GUID id)
			throws HeadlessException {
		super("Text Editor _ " + arg0);
		userName = arg0;
		this.store = store;
		PDHistory.load(store, id);
		...
		*/
		textPanel = new TextPanel(this, store, id);		
		historyPanel = new HistoryPanel(this, store, id);
		operationPanel = new OperationPanel(this, store, id);
...
*/
	...
	public static void main(String[] args) {
		...
		guid1 = new GUID();
		history = new PDHistory(mainStore, guid1);	
		history.removeOperation();
		
		originator = new PDWord(mainStore);
		originator.setText("");
		mainStore.commit();

		Frame frame1 = new TextEditor("Bob", mainStore, guid1);
		Frame frame2 = new TextEditor("Alice", mainStore, guid1);

		mainStore.getDetachedListenerList().add(
				new ComponentRoleListener(
