...
public class PDInsert implements PDInstance {
	...
	public static void register() {
		PDStore.addDataClass(typeId, PDInsert.class);
	}
	...
	/**
	 * Creates an PDInsert object representing a PDStore instance of type Insert.
	 * @param store the store the instance should be in
	 */
	public PDInsert(PDStore store) {
		this(store, new GUID());
	}

	/**
	 * Creates an PDInsert object representing the instance with the given ID. 
	 * The ID must be of an instance of type Insert.
	 * @param store the store the instance should be in
	 * @param id GUID of the instance
	 */
	public PDInsert(PDStore store, GUID id) {
		this.store = store;
		this.id = id;
	...
	/**
	 * Loads an object for the instance of PDStore type Insert with the given ID.
	 ...
	 * @param id GUID of the instance
	 */
	public static PDInsert load(PDStore store, GUID id) {
	 ...
	 */
	public PDWord getAfter() {
		GUID instanceId = (GUID) store.getInstance(this.id, roleAfterId);
	 ...
	 */
	 public Collection<PDWord> getAfters() {
		return (Collection<PDWord>)(Object)store.getAndLoadInstances(this.id, roleAfterId, PDWord.typeId);
	 }
   ...
   /**
	 ...
	 */
	public void addAfter(GUID after) {
		if (after != null) {
			store.addLink(this.id, roleAfterId, after);
		}
	}
	/**
	 * Connects this instance to the given instance using role "after".
	 ...
	 * @param after the instance to connect
	 */
	public void addAfter(PDWord after) {
		if (after != null)
	 ...
	 * @param after the Collection of instances to connect
	 */
	public void addAfters(Collection<PDWord> afters) {
		if (afters == null)
			return;
		for (PDWord instance : afters)
			addAfter(instance);
	}
	...
	public void removeAfter() {
		store.removeLink(this.id, roleAfterId,
			store.getInstance(this.id, roleAfterId));
	}
	 ...
	 * If the given instance is null, nothing happens.
	 */
	public void removeAfter(Object after) {
		if (after == null)
			return;
		store.removeLink(this.id, roleAfterId, after);
	}

	/**
	 * Removes the links from this instance through role "after" to the instances
	 * in the given Collection, if the links exist.
	 * If there are no such links or the collection argument is null, nothing happens.
	 */
	public void removeAfters(Collection<PDWord> afters) {
		if (afters == null)
			return;
		for (PDWord instance : afters)
			store.removeLink(this.id, roleAfterId, instance);
	}
	 ...
	 * @param after the instance to connect
	 */
	public void setAfter(GUID after) {
		store.setLink(this.id,  roleAfterId, after);
	}
	/**
	 * Connects this instance to the given instance using role "after".
	 * If there is already an instance connected to this instance through role "after", the link will be overwritten.
	 ...
	 * @param after the instance to connect
	 */
	public void setAfter(PDWord after) {
