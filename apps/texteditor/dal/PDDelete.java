...
/**
 * Data access class to represent instances of type "Delete" in memory.
 * Note that this class needs to be registered with PDCache by calling:
 *    Class.forName("texteditor.dal.PDDelete");
 * @author PDGen
 */
public class PDDelete implements PDInstance {

	public static final GUID typeId = new GUID("3c08266454d111e09c2a001e6805726d"); 

	public static final GUID roleWordId = new GUID("3c08266e54d111e09c2a001e6805726d");
	...
	public static void register() {
		PDStore.addDataClass(typeId, PDDelete.class);
	}
	...
	public String toString() {
		String name = getName();
		if(name!=null)
			return "PDDelete:" + name;
		else
			return "PDDelete:" + id;
	}

	/**
	 * Creates an PDDelete object representing a PDStore instance of type Delete.
	 * @param store the store the instance should be in
	 */
	public PDDelete(PDStore store) {
		this(store, new GUID());
	}

	/**
	 * Creates an PDDelete object representing the instance with the given ID. 
	 * The ID must be of an instance of type Delete.
	 * @param store the store the instance should be in
	 * @param id GUID of the instance
	 */
	public PDDelete(PDStore store, GUID id) {
		this.store = store;
		this.id = id;
	...
	/**
	 * Loads an object for the instance of PDStore type Delete with the given ID.
	 ...
	 * @param id GUID of the instance
	 */
	public static PDDelete load(PDStore store, GUID id) {
		PDInstance instance = store.load(typeId, id);
		return (PDDelete)instance;
	}
