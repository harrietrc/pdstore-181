...
class BaseProtocol
{
	...
	public void sendCode(int code) throws IOException
	{
		...
		{
			System.err.println("Error in base protocol sendCode");
			System.err.println(e);
			throw e;
		}
	}
	...
	public void sendString(String string)
	{
		...
		{
			System.err.println("Error in base protocol sendString");
			System.err.println(e);
			System.exit(-1);
		}
	}
	...
	public int recieveCode() throws IOException
	{
		...
		{
			System.err.println("Error in base protocol recieveCode");
			System.err.println(e);
			throw e;
		}
	}
	...
	public long recieveLong() throws IOException
	{
		...
		{
			System.err.println("Error in base protocol recieveLong");
			System.err.println(e);
			throw e;
		}
	}
	...
	public byte[] recieveBytes(Integer length) throws IOException
	{
		...
		{
			System.err.println("Error in base recieveBytes");
			System.err.println(e);
			throw e;
		}	
	}
	...
	public String recieveString(Integer length) throws IOException
	{
		...
		{
			System.err.println("Error in base protocol recieveString");
			System.err.println(e);
			throw e;
		}
	}
