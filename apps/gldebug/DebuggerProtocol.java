...
public class DebuggerProtocol
{
	...
	{
		void breakEventHit(String functionName, String breakEvent);
	}
	...
	protected List<BreakEventListener> breakEventListeners;
	...
	public DebuggerProtocol(Socket sock)
	{
		...
		breakEventListeners = new ArrayList<BreakEventListener>();
	...
	public Response getResponseBreakEvent(int code, int id) throws IOException
	{
		...
		for(BreakEventListener listener : breakEventListeners)
			listener.breakEventHit(r.call, r.event);
		return (Response)r;
	}
	...
	boolean sendRun(int id)
	{
		...
		{
			System.err.println("Error sending run command");
		}
	...
	void sendContinue(int id)
	{
		...
		{
			System.err.println("Error sending continue command");
		}
	}
	...
	void sendStep(int id)
	{
		...
		{
			System.err.println("Error sending step command");
		}
	}
	...
	void sendQuit(int id)
	{
		...
		{
			System.err.println("Error sending quit command");
		}
	}
	...
	void sendEnableDisable(int id, String filterset, boolean enable)
	{
		...
		{
			System.err.println("Error sending enable/disable command");
		}
	}
	...
	void sendScreenshot(int id)
	{
		...
		{
			System.err.println("Error sending screenshot command");
		}
	}
	...
	void sendAsync(int id)
	{
		...
		{
			System.err.println("Error sending stop command");
		}
	}
	...
	void sendStateTree(int id)
	{
		...
		{
			System.err.println("Error sending state tree request");
		}
	}
								...
								int type)
	{
		...
		{
			System.err.println("Error sending data request");
		}
	}
									...
									int buffer, int format, int type)
	{
		...
		{
			System.err.println("Error sending framebuffer request");
		}
	}
	...
	void sendDataShader(int id, int shaderId, int target)
	{
		...
		{
			System.err.println("Error sending shader request");
		}
	}
	...
	void sendDataInfoLog(int id, int objectId, int target)
	{
		...
		{
			System.err.println("Error sending info log request");
		}
	}
	...
	void sendDataBuffer(int id, int objectId)
	{
		...
		{
			System.err.println("Error sending data buffer request");
		}
	}
	...
	void setBreakEvent(int id, int event, boolean brk)
	{
		...
		{
			System.err.println("Error sending break event");
		}
	}
	...
	void setBreak(int id, String function, boolean brk)
	{
		...
		{
			System.err.println("Error sending breakpoint");
		}
	}
	...
	public boolean[] getBreakOnEvent()
	{
		return breakOnEvent;
	}
	...
	public void addBreakEventListener(BreakEventListener listener)
	{
		breakEventListeners.add(listener);
	}
	
	public void removeBreakEventListener(BreakEventListener listener)
	{
		breakEventListeners.remove(listener);
	}
