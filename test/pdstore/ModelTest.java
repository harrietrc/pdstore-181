...
public class ModelTest {
	...
	public static void setUpClass() {
		...
		String fileName = "ModelTest-" + System.nanoTime();
	...
	public final void testGetAllInstancesOfType() {
		...
		assertTrue(result.contains(PDStore.OWNED_ROLE_ROLEID.getPartner()));
	...
	public final void testGetAccessorType() {
		GUID t = store.begin();
		assertEquals(PDStore.ROLE_TYPEID,
				store.getAccessorType(t, PDStore.MIN_MULT_ROLEID));
		assertEquals(PDStore.ROLE_TYPEID,
				store.getAccessorType(t, PDStore.MAX_MULT_ROLEID));
		assertEquals(PDStore.OBJECT_TYPEID,
				store.getAccessorType(t, PDStore.NAME_ROLEID));
		assertEquals(PDStore.MODEL_TYPEID,
				store.getAccessorType(t, PDStore.MODELTYPE_ROLEID));
		assertEquals(PDStore.OBJECT_TYPEID,
				store.getAccessorType(t, PDStore.HAS_TYPE_ROLEID));
		store.commit(t);
	}
	...
	public final void testGetOwnerType() {
		...
		assertEquals(PDStore.INTEGER_TYPEID,
				store.getOwnerType(t, PDStore.MIN_MULT_ROLEID));
		assertEquals(PDStore.INTEGER_TYPEID,
				store.getOwnerType(t, PDStore.MAX_MULT_ROLEID));
		assertEquals(PDStore.STRING_TYPEID,
				store.getOwnerType(t, PDStore.NAME_ROLEID));
		assertEquals(PDStore.TYPE_TYPEID,
				store.getOwnerType(t, PDStore.MODELTYPE_ROLEID));
		assertEquals(PDStore.TYPE_TYPEID,
				store.getOwnerType(t, PDStore.HAS_TYPE_ROLEID));
		store.commit(t);
	}
}