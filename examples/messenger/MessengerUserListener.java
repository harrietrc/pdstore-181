...
public class MessengerUserListener extends
		PDListenerAdapter<GUID, Object, GUID> {
	/* Stephen Hood 05/09/12: This class is based on RepaintListener in the
	 ...
	 * two things happen via messenger.doUserRefresh() being called here.
	...
	public MessengerUserListener(Messenger messenger) {
		super();
