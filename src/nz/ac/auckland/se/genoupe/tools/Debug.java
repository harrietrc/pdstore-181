...
public class Debug {
	...
	private Map<String, Object> debugTags = new ConcurrentHashMap<String, Object>();
	 ...
	 */
	public static void println(L message, Object... debugTopics) {
	...
	public static boolean isDebugging(int depth, Object... debugTopics) {
		return err.isGlobalDebug() || debugTopics == null
				|| debugTopics.length == 0 || isDebuggingTopic(debugTopics);
	}
