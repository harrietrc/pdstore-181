...
public class AggregationIterator<TransactionType extends Comparable<TransactionType>, InstanceType, RoleType extends Pairable<RoleType>>
	...
	public AggregationIterator(
			Iterator<PDChange<TransactionType, InstanceType, RoleType>> baseIterator, boolean onlyAdded) {
		super(baseIterator);
		this.onlyAdded = onlyAdded;
	}
	...
	public boolean filterCondition(
		...
		if(onlyAdded)
		   return (change.getChangeType()==ChangeType.LINK_ADDED);
		else 	
	       return true;
	}
}
