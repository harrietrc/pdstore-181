...
public class FilledCircle implements WidgetI {

	final public static GUID widgetID = new GUID(
			"6e4a108093ef11e1ac19842b2b9af4fd");

	public static void register(PDStore store) {
		store.setName(widgetID, "Circle");
		store.setType(widgetID, PDStore.WIDGET_TYPEID);
		store.setLink(widgetID, PDStore.WIDGET_IMPLEMENTATION_ROLEID,
				"pdstore.ui.widgets.FilledCircle");
	}
